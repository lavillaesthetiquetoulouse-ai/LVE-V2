...
export const metadata: Metadata = {
  title: 'Traitements Médecine Esthétique Toulouse | Laser, Injections | Dr Baron',
  description: 'Tous nos soins de médecine esthétique à Toulouse : acide hyaluronique, épilation laser Clarity 2, Morpheus 8, peeling, cryolipolyse. Dr Nadine Baron ⭐ 4.9/5 · RDV en 48h.',
